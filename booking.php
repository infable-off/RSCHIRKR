            ...
            <div class="booking-form-container">
                <form action="verify.php" method="POST">
                    ...
                    <select name="date" required>
                        ...
                        <option value="13-3">October 13,2022</option>
                        <option value="14-3">December 18,2022</option>
                        <option value="15-3">Juny 15,2023</option>
                        <option value="16-3">September 30,2024</option>
                    </select>
